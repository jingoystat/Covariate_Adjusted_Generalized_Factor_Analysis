...
AM_estimation_anchor=function(Y, X, r, tol=0.001, tau=5, ite=1, maxiter=20, anchor_num, anchor_type, seed)
{
  ...
  return(list("Gamma1"=Gam_opt, "Beta1"=Beta_opt, "U1"=U_opt))
}
